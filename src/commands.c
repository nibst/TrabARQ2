...
int EDIT_function(Arguments *arguments)
{
    ...
    BYTE index, i = 0,cluster_atual,aux;
    ...
    while(tam >= (sizeof(Cluster) - 3))
    {
        ...
        //conteudo_arquivo[(sizeof(Cluster) - 3) - 1] = c;
...
int RENAME_function(Arguments *arguments)
{
    ...
    //checa se ja existe file com esse nome que quer mudar
    ...
    free(arg_copy);
    free(caminho_arquivo);
    printf("File/Directory '%s' renamed to '%s'\n\n", caminho_arquivo, novo_nome_arquivo);
    return 0;
}
